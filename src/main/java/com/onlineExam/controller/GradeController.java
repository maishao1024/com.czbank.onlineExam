...
//    @ResponseBody
//    public DataResult submitContest(HttpServletRequest request, @RequestBody Grade grade) {
...
//        return new DataResult().setData(gradeId);
//    }
//
//    //完成批改试卷
//    @RequestMapping(value="/api/finishGrade", method= RequestMethod.POST)
//    @ResponseBody
//    public DataResult finishGrade(@RequestBody Grade grade) {
//        DataResult pageResult = new DataResult();
